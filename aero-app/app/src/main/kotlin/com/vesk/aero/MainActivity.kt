...
class MainActivity : FragmentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge(
            statusBarStyle = SystemBarStyle.light(android.graphics.Color.parseColor("#0A0F16"), android.graphics.Color.parseColor("#0A0F16")),
            navigationBarStyle = SystemBarStyle.dark(android.graphics.Color.parseColor("#0A0F16")),
        )
